...
df = pd.read_csv("52L_full_info.data", header=None, delimiter=" ")
...
for mc_temp in range(len(df.columns)-1):
    ...
    axs.set_title("Tet-full / 52L", fontsize=24)
    ...
    fig.savefig('01_ratio_figs/fe3oct_%i.png' %mc_temp, dpi=300.0,format='png', bbox_inches = "tight")
