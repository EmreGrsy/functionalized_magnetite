...
set nlayer 17
set over_head 001-dbt_3x3_17L_fa_int_full

# Number of oct layers
set noctl [expr {($nlayer +1)/2}]

# Topmost fe_oct ions zmin and zmax
set topmost {76.2 77.1}

# Distance between fe oct layers
set oct_oct 2.1

set info_data [open "../2_eq/info.data" r]

set log [open "${nlayer}L_half_info.data" w]
...
while {[gets ${info_data} line] != -1} {
	...
	topo readlammpsdata ../2_eq/${over_head}_${step}_${mc_temp}K.data
