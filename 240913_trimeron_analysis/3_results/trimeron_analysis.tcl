...
puts $file "number_Fe2,index_Fe3,index_Fe2,index_Fe3,distance_Fe3Fe3,angle_Fe3Fe2Fe3,zdistance_Fe3Fe3"
...
foreach i3 [$fe2_oct get index] {
	...
	foreach i1 [$coordinated_fe3 get index] {
				...
				set 1fe3fe2_dist [measure bond [list $i3 $i2]]
				set 2fe3fe2_dist [measure bond [list $i3 $i1]]
                                ...
                                if {($dummy_angle < 184) && ($dummy_angle > 176) && ($fe3fe3_dist > 5.8)} {
                                    ...
                                    puts $file "$num_fe2_oct,$i1,$i3,$i2,$fe3fe3_dist,$dummy_angle,$z_i1i2dist,$2fe3fe2_dist,$2fe3fe2_dist"
					...
					if {($nfe3_near == 1)} {
						...
						if {($angle < 184) && ($angle > 176) && ($fe3fe3_constructed > 5.8)}  {
							puts $file "$num_fe2_oct,$i1,$i3,$i2,$fe3fe3_constructed,$angle,[expr abs($z_dist)],$lfe2fe3_far,$lfe2fe3_far"
						}
					}
				}
                        }
